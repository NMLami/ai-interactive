...
const TextToSpeechSwedish = () => {
  ...
  const goToEnglish = () => {
    ...
    history.push(`/interactive-friend/${grp}`);
  };
    ...
    <Button className='mx-2' variant="contained" color="primary" onClick={goToEnglish}>
          Ask In English
          </Button>
    </div>
...
export default TextToSpeechSwedish;